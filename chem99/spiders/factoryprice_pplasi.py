...
class FactorypricePplasiSpider(scrapy.Spider):
    name = "factoryprice_pplasi"
    ...
    def parse(self, response):
        self.crawler.stats.set_value('spiderlog/source_name', u'卓创-国内PP拉丝出厂价')
    ...
    def login_callback(self, response):
        request = scrapy.http.Request(url='http://plas.chem99.com/news/s0-0-B9FAC4DA5050C0ADCBBF.html', 
